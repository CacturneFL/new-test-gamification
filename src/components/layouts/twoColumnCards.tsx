...
export default function TwoColumnCards({ step, selected, onSelect }: LayoutProps) {
  return (
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {step.options?.map((option, index) => (
          <motion.button
            ...
            className={`rounded-2xl border px-5 py-5 text-left transition hover:border-brand-400 hover:bg-brand-500/10 ${
              selected === option.id
